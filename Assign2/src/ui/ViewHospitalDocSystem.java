 ...
 */
public class ViewHospitalDocSystem extends javax.swing.JFrame {

    /**
     * Creates new form ViewHospitalDocSystem
     */
    ...
    private boolean validateData5() {
                if (nametxthosp.getText().length() < 1) {
            JOptionPane.showMessageDialog(this, "Hospital Name is required!!");
            return false;
        }
                        if (addresstxthosp.getText().length() < 1) {
            JOptionPane.showMessageDialog(this, "Hospital Address is required!!");
            return false;
        }
                        if (citytxthop.getText().length() < 1) {
            JOptionPane.showMessageDialog(this, "City Required");
            return false;
        }
                        if (zipcodetxthosp.getText().length() < 1) {
            JOptionPane.showMessageDialog(this, "ZipCode required");
            return false;
        }
                                  if (namevdoctxthos.getText().length() < 1) {
            JOptionPane.showMessageDialog(this, "Doctor Name is required");
            return false;
        }
                  
         if (gendervdoctxthos.getText().length() < 1) {
            JOptionPane.showMessageDialog(this, "Gender is required");
            return false;
        }
                        if (emailidvdoctxthos.getText().length() < 1) {
            JOptionPane.showMessageDialog(this, "Email id is required");
            return false;
        }
                        if (contactnovdoctxthos.getText().length() < 1) {
            JOptionPane.showMessageDialog(this, "Contact Number is required");
            return false;
        }
                        if (degreevdoctxthos.getText().length() < 1) {
            JOptionPane.showMessageDialog(this, "Degree is  required");
            return false;
        }
                                  if (specialityvdoctxthos.getText().length() < 1) {
            JOptionPane.showMessageDialog(this, "Please Enter Speciality");
            return false;
        }      
                                  if (experiencevdoctxthos.getText().length() < 1) {
            JOptionPane.showMessageDialog(this, "Please Enter Speciality");
            return false;
        }     
                                                if (availibilitytxthos.getText().length() < 1) {
...
return true;    }
    private void createbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createbtnActionPerformed
        ...
        boolean valid=validateData5();
        if(valid){
        String hospitalname= nametxthosp.getText();
        String hospitaladdress= addresstxthosp.getText();
        String hcity= citytxthop.getText();
        int hzipcode= Integer.parseInt(zipcodetxthosp.getText());
        String name= namevdoctxthos.getText();
        String gender= gendervdoctxthos.getText();
        String emailid= emailidvdoctxthos.getText();
        long contactno= Long.parseLong(contactnovdoctxthos.getText());
        String degree= degreevdoctxthos.getText();
        String speciality= specialityvdoctxthos.getText();
        String experience = (experiencevdoctxthos.getText());
        String availability=(availibilitytxthos.getText());
