...
public class PatientDirectoryJFrame extends javax.swing.JFrame {
    ...
    private void updatebtnpdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updatebtnpdActionPerformed
        ...
        selectedPatient.setTodaysdate(datetxtpd.getText());
        ...
        if(i<0)
        {
            ...
            model.setValueAt(datetxtpd.getText(), i, 5);
            model.setValueAt(maritaltxtpd.getText(), i, 6);
            model.setValueAt(insurancetxtpd.getText(), i, 7);
            model.setValueAt(allergiestxtpd.getText(), i, 8);
            model.setValueAt(emergencytxtpd.getText(), i, 9);
            model.setValueAt(medicaltxtpd.getText(), i, 10);
            model.setValueAt(symptomstxtpd.getText(), i, 11);
